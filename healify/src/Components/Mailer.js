...
export const Mailer = () => {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ marginTop: "25px",textAlign:"center",fontFamily:"cursive" }}>Send Email</h2>
      <form
        className="row"
...
{/*<label style={{fontFamily:"cursive",fontWeight:"bold"}}>User Name</label>
        ...
        <label style={{fontFamily:"cursive",fontWeight:"bold"}}>User Name</label></i>
      ...
      {/*  <label  style={{fontFamily:"cursive"}}>User Email</label>
        ...
        <label  style={{fontFamily:"cursive",fontWeight:"bold"}}>Email</label></i>
        <input type="email" name="recipient_email" className="form-control" />
        <br/>
        <br/>
          <i className="fas fa-pencil">
        <label  style={{fontFamily:"cursive"}}>Message</label> </i>
        ...
        <input
          ...
          style={{ marginTop: "40px" ,fontFamily:"cursive",fontWeight:"bold"}}
        />
